...
int main() {
  ...
  while(l <= h)
  {
    ...
    else
    {
      ...
      nf.insert(fac_opened);
      // cout << "at cost = " << cst << ", factilites opened = " << fac_opened << endl;
    }
    if(fac_opened < k)
      h = mid - 1;
    else if(fac_opened > k)
      l = mid + 1;
    else
    {
      cout << k << " facilities opened at " << mid << endl;
      return 0;
    }

  }
  cout << "all costs traversed : ";
  for(auto i : nf)
    cout << i  << " ";
  cout << endl;
  return 0;
